                  ...
                  >
                    ...
                    <CardContent className="p-4">
                      ...
                      <div className="flex gap-2">
                        ...
                        {( (attraction.lat && attraction.lng) || attraction.mapUrl ) && (
                          <Button
                            variant="default"
                            size="sm"
                            onClick={() => {
                              if (attraction.mapUrl && attraction.mapUrl.startsWith('http')) {
                                window.open(attraction.mapUrl, '_blank');
                              } else if (attraction.lat && attraction.lng) {
                                openInGoogleMaps(attraction.lat, attraction.lng, attraction.nameAr);
                              }
                            }}
