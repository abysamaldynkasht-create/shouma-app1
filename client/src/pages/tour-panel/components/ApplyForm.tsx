...
import { CheckCircle2, MapPin, Phone, Clock, User, Send, Globe, ArrowRight } from 'lucide-react';
        ...
        <AnimatePresence mode="wait">
          {!isSubmitted ? (
            <motion.div
              ...
              exit={{ opacity: 0, y: -15 }}
              className="bg-slate-950/60 border border-slate-800 rounded-3xl overflow-hidden shadow-2xl p-6 sm:p-10 backdrop-blur-xl"
            >
              {/* Header */}
              <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8 border-b border-slate-800 pb-6">
                ...
                <button
                  ...
                  className="flex items-center gap-1.5 px-4 py-2 bg-slate-800 hover:bg-slate-700 text-slate-300 rounded-xl text-sm font-medium transition-all cursor-pointer"
                >
            ...
            >
              ...
              <p className="text-xl text-slate-300 font-medium max-w-xl mx-auto mb-8 leading-relaxed text-center">
